...
function calculateLST(date, longitude) {
    ...
    let lstHours = (apparentSiderealTime + lonRad * 12 / Math.PI) % 24;
    if (lstHours < 0) {
        lstHours += 24;
    }
...
// Example usage: Calculate LST for 25th September 2002 at 6:30 UTC with longitude 72°53' E
const date = new Date('2002-09-25T00:00:00Z'); // 6:30 UTC
const longitude = 72.8833; // Longitude in degrees

const lst = calculateLST(date, longitude);
console.log(`Local Sidereal Time (LST) for 25th September 2002 at 6:30 UTC with longitude ${longitude}°E: ${lst}`);
